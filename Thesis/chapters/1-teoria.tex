...
\subsection{Wprowadzenie do uczenia maszynowego}

\begin{itemize}
  \item Definicja i cele uczenia maszynowego
  \item Przykłady zastosowań w medycynie i diagnostyce
\end{itemize}

\subsection{Typy uczenia maszynowego}

\begin{itemize}
  \item Uczenie nadzorowane, nienadzorowane i wzmacniane
  \item Przykłady i różnice między typami uczenia
\end{itemize}
...
\begin{itemize}
  ...
  \item K-najbliższych sąsiadów (k-NN): klasyfikacja oparta na podobieństwie
\end{itemize}
...
\subsection{Wykorzystanie sieci konwolucyjnych (CNN)}
...
\subsection{Uczenie transferowe i użycie modeli pre-trenowanych}

\begin{itemize}
  \item Zalety wykorzystania pretrenowanych modeli

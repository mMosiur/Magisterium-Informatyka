...
\begin{itemize}
  ...
  \item \emph{Uczenie nadzorowane} (ang. \emph{supervised learning}) --
        ...
        % TODO: Dopisać coś o regresji (https://en.wikipedia.org/wiki/Machine_learning#:~:text=Types%20of%20supervised%2Dlearning%20algorithms%20include%20active%20learning%2C%20classification%20and%20regression.)
  ...
  \item \emph{Uczenie nienadzorowane} (ang. \emph{unsupervised learning}) --
        coś o uczeniu nienadzorowanym

  \item \emph{Uczenie wzmacniane} (ang. \emph{reinforcement learning}) --
        coś o uczeniu wzmacnianym

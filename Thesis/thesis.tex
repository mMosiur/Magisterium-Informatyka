...
\hypersetup{
	...
	pdfkeywords={Choroba Alzheimera, demencja, uczenie maszynowe, uczenie transferowe, głębokie sieci neuronowe, sieci konwolucyjne, .NET, dotnet, CSharp}
}
\usepackage{graphicx}
...
\include{chapters/streszczenie-pl}
\include{chapters/streszczenie-en}
...
\include{chapters/1-teoria}
\include{chapters/2-metodologia}
\include{chapters/3-badanie}
\include{chapters/4-dyskusja}
